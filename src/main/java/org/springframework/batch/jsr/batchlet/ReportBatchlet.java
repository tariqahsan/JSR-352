...
public class ReportBatchlet implements Batchlet {
	...
	public String process() throws Exception {
		...
		//File outputDirectory = new File("c:\\output\\");
		//if(!outputDirectory.exists()) {
			//outputDirectory.mkdir();
		//}

		//Writer outWriter = new OutputStreamWriter(new FileOutputStream("/tmp/jsr_temp/output/index.html"));
		Writer outWriter = new OutputStreamWriter(new FileOutputStream("C:\\Users\\Tariq\\workspace\\jsr-talk\\src\\main\\resources\\output\\index.html"));
